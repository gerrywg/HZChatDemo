...
CGFloat const textMarginToBorder    = 8.0;
CGFloat const textLineSpacing       = 5.0;
CGFloat const textParagraphSpacing  = 5.0;

CGFloat const mediaViewCornerRadius = 5.0;

CGFloat const mediaArrowViewBorderWidth  = 0.5;
CGFloat const mediaArrowViewCornerRadius = 5.0;
CGFloat const mediaArrowViewNeckHeight   = 10.0;
